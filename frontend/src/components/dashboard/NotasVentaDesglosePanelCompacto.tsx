...
interface NotasVentaDesglosePanelCompactoProps {
  totalPagado: number;
...
/**
 * NotasVentaDesglosePanelCompacto Component
 * Panel de desglose de Notas de Venta con métricas de pagos (diseño Nubofact)
 */
export function NotasVentaDesglosePanelCompacto({ 
  totalPagado, 
  totalPorPagar, 
  total,
  className 
}: NotasVentaDesglosePanelCompactoProps) {
  return (
